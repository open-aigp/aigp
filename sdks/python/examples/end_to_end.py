...
def main():
    ...
    tracer = trace.get_tracer("aigp.example", "0.13")
    ...
    try:
        ...
        from aigp.events import sign_event, verify_event_signature
    ...
    from aigp.events import compute_leaf_hash, compute_merkle_governance_hash
