...
| `_schemaURL` | String (URI) | Yes | JSON Pointer to schema version | `"https://github.com/open-aigp/aigp/blob/v0.13/..."` |
...
| `specVersion` | String | No | AIGP specification version | `"0.13"` |
