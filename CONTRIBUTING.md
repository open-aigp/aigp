...
- [Open an Issue](https://github.com/open-aigp/aigp/issues)
- [Start a Discussion](https://github.com/open-aigp/aigp/discussions)
- Discuss with maintainers: [GitHub Discussions](https://github.com/open-aigp/aigp/discussions)
- Visit [open-aigp.org](https://open-aigp.org) for the web version of the specification
